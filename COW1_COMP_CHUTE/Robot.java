...
public class Robot extends IterativeRobot {
    ...
    // Magnitude (speed), Direction (degrees), Rotation (Turning) 
	 private double orch_A_Left_Time 	=  0.6;
	 private double orch_A_Left_Mag 	=  0.2;
	 private double orch_A_Left_Dir	 	=  0.0;
	 private double orch_A_Left_Rot 	=  0.0;
	 
	 //  Orchestration B  Left Variables 
	 private double orch_B_Left_Time 	=  0.6;
	 private double orch_B_Left_Mag 	=  0.0;
	 private double orch_B_Left_Dir	 	=  0.0;
	 private double orch_B_Left_Rot 	=  0.5; 
	 
	 //  Orchestration C  Left Variables 
	 private double orch_C_Left_Time 	=  1.3;
	 private double orch_C_Left_Mag 	=  0.2;
	 private double orch_C_Left_Dir	 	=  0.0;
	 private double orch_C_Left_Rot 	=  0.0; 
	 
	 // Orchestration A Right Variables 
     // Magnitude (speed), Direction (degrees), Rotation (Turning) 
	 private double orch_A_Right_Time 	=  0.6;
	 private double orch_A_Right_Mag 	=  0.2;
	 private double orch_A_Right_Dir	=  0.0;
	 private double orch_A_Right_Rot 	=  0.0;
	 
	 // Orchestration B Right Variables
	 private double orch_B_Right_Time 	=   0.5;
	 private double orch_B_Right_Mag 	=   0.0;
	 private double orch_B_Right_Dir	=   0.0;
	 private double orch_B_Right_Rot 	=  -0.5;
	 
	 //  Orchestration C  Right Variables 
	 private double orch_C_Right_Time 	=  2.25;
	 private double orch_C_Right_Mag 	=  0.2;
	 private double orch_C_Right_Dir	=  0.0;
	 private double orch_C_Right_Rot 	=  0.0; 
	
	 // Orchestration A Center Variables 
     // Magnitude (speed), Direction (degrees), Rotation (Turning) 
	 private double orch_A_Center_Time 	=  1.0;
	 private double orch_A_Center_Mag 	=  0.0;
	 ...
	 private double MainTimer, autoTimerStart1Left, autoTimerStart2Left, autoTimerStart3Left; 
	 private double autoTimerStart1Right, autoTimerStart2Right, autoTimerStart3Right;
	 private double autoTimerStart1Center;
    ...
    // Autonomous Initialization only runs once per match. 
    public void autonomousInit(){
    	...
    	timer3Left = new Timer();
    	
    	timer1Right = new Timer();
    	timer2Right = new Timer();
    	timer3Right = new Timer();
    	
    	timer1Center = new Timer();
    	
    	controlChuteLeft   = new boolean[] {false, false, false};
    	controlChuteRight  = new boolean[] {false, false, false};
    	controlChuteCenter = new boolean[] {false};
    ...
    public void autonomousPeriodic() {
        ...
        if (DigitalInput4.get() 		== false 
         ...
         if (b_leftDriveAutonomous 			== true
             ...
             && b_downAutonomous			== false) {
        	    ...
        	    if (controlChuteLeft[1] == true) {	
        		    while ((autoTimerStart2Left = timer2Left.get()) < orch_B_Left_Time) { 
        	         ...
        	         controlChuteLeft[2] = true;
          	         timer3Left.reset();
          	         timer3Left.start();   
        	    }
        		 
        	    // Orchestration C Left
        	    if (controlChuteLeft[2] == true) {
        		    while ((autoTimerStart3Left = timer3Left.get()) < orch_C_Left_Time) { 
        		     robotDrive.mecanumDrive_Polar(orch_C_Left_Mag, orch_C_Left_Dir, orch_C_Left_Rot); // Magnitude (speed), Direction (degrees), Rotation (Turning)
        		    }
          ...
          if (b_rightDriveAutonomous 	== true
     	    ...
     	    // Orchestration C Right
    	    if (controlChuteRight[2] == true) {
    		    while ((autoTimerStart3Right = timer3Right.get()) < orch_C_Right_Time) { 
    		     robotDrive.mecanumDrive_Polar(orch_C_Right_Mag, orch_C_Right_Dir, orch_C_Right_Rot); // Magnitude (speed), Direction (degrees), Rotation (Turning)
    		    }
        ...
        // Begin driving no limit switch since we might drive while lifting the can TBD. 
           ...
           SmartDashboard.putNumber("autoTimerStart3Left", autoTimerStart3Left);
           ...
           SmartDashboard.putNumber("autoTimerStart3Right", autoTimerStart3Right); 
